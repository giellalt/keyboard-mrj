.. -*- mode: rst -*-
==========================================
 Keyboards for the Western Mari language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Western Mari language. The data and implementations
...
* http://giellatekno.uit.no/mrjdoc/index.html
* https://giellalt.uit.no/tools/docu-mrj-manual.html
...
The Western Mari keyboard sources can be acquired using the `Giella SVN
